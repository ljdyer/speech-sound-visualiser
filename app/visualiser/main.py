...
# ====================
def save_plots(filename: str, save_path: str):
    ...
    WAVEFORM_FILENAME = join(save_path, 'waveform.png')
    SPECTRUM_FILENAME = join(save_path, 'spectrum.png')
    SPECTROGRAM_FILENAME = join(save_path, 'spectrogram.png')
    MEL_SPECTROGRAM_FILENAME = join(save_path, 'mel_spectrogram.png')
